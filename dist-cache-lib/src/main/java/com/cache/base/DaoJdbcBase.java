...
public class DaoJdbcBase {
    ...
    public DaoJdbcBase(String jdbcUrl, String jdbcDriver, String jdbcUser, String jdbcPass, int initConn, int maxActiveConn) {
    ...
    public DaoJdbcBase(String jdbcUrl, String jdbcDriver, String jdbcUser, String jdbcPass) {
        this.jdbcUrl = jdbcUrl;
        this.jdbcDriver = jdbcDriver;
        this.jdbcUser = jdbcUser;
        this.jdbcPass = jdbcPass;
    ...
    public void onInitialize() {
        try {
            ...
            log.info("Connected!!!! to Connection Pool, URL=" + jdbcUrl);
        } catch (Exception ex) {
            log.info("Cannot connect to JDBC at URL:" + jdbcUrl + ", reason: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
