...
public class DaoBase {
    ...
    public DaoBase(String jdbcUrl, String jdbcDriver, String jdbcUser, String jdbcPass, int initConn, int maxActiveConn) {
    ...
    public DaoBase(String jdbcUrl, String jdbcDriver, String jdbcUser, String jdbcPass) {
        this.jdbcUrl = jdbcUrl;
        this.jdbcDriver = jdbcDriver;
        this.jdbcUser = jdbcUser;
        this.jdbcPass = jdbcPass;
